var config = require('../config/develovment')
...
module.exports = {
    getToken: async function () {
        let response = await axios.get(URL+'/user/token/')
    ...
    login: async function (token) {
        let url = URL+"/user/login?token=" + token
        console.log(url)
        let config = {
            method: 'POST',
    ...
    getUserInfo: async function (token) {
        let response = await axios.get(URL+'/user?token=' + token)
            .catch(function (error) {
                if (error.response) {
                    console.log(error.response.data);
                    console.log(error.response.status);
    ...
    sendDataset: function (options) {
        let url = URL+"/exchange/?token=" + token
        //console.log(url)
        let config = {
